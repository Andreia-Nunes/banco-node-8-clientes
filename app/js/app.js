...
const c3 = new Conta('12345', 500000);
const contaEspecial = new Conta('67890', 1000000);
...
const clienteEspecial = new ClienteEspecial("Andréia Nunes", "000.111.222-33", c3, contaEspecial);

const clientes = new Clientes();
clientes.inserir(cli1);
clientes.inserir(cli2);
clientes.inserir(cli3);
clientes.inserir(clienteEspecial);
const cliPesquisado = clientes.pesquisarPorCPF('000.111.222-33');
